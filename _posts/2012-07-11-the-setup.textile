...
* *"OmniPlan":http://www.omnigroup.com/products/omniplan/* ($99.99) is a great project planning tool. Works wonders for Gantt charts.
...
* *"MindNode Pro":http://mindnode.com/* ($9.99) is super useful for mind-mapping, and I especially like it because it can be manipulated entirely with the keyboard. The non-pro version is free, but the pro version allows you to place images/video/documents in your mind map. Super cool.
